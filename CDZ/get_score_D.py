...
parser.add_argument("-c", "--control", required=True, help="control sample");
parser.add_argument("-t", "--treated", required=True, help="treated samples");
...
def main():
	...
	treated=args.treated.replace(' ', '').split(",");
	SAMPLES=[];
	...
	score_D_DF.to_csv("score_D.txt", sep="\t");
